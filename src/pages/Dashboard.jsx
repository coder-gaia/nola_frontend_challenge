...
import { layout } from "../config/dashboardLayout.json";
...
function Dashboard() {
  ...
  const renderSection = (section) => {
    switch (section) {
      ...
      case "products":
        return (
          <div key="products" style={{ marginTop: 16 }}>
      ...
      case "financial":
        return (
          <div key="financial" style={{ marginTop: 16 }}>
